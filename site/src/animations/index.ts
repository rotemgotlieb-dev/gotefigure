...
// store UI. flood-nav binds once at import (global nav behavior). countdown.ts retired
// 2026-07-29: countdown widgets are banned by owner decision (WNM Plan line 85).
